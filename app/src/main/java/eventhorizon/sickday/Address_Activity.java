...
/**
 * Created by marcusmotill on 3/29/15.
 */
public class Address_Activity extends Activity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PlacesAutoCompleteAdapter autocompleteadapter = new PlacesAutoCompleteAdapter(this, R.layout.list_item);
